...
test.describe("Profile Page tests", () => {
    ...
    test("Update name successfully", async ({ page }) => {
        ...
        await expect(page.locator(".d-flex.align-items-center.gap-5 p.lorem").nth(0)).toHaveText("Cang")
    })
    ...
    test("Update phone successfully", async ({ page }) => {
        ...
        await expect(page.locator(".d-flex.align-items-center.gap-5 p.lorem").nth(1)).toHaveText("1234567890")
    })
    ...
    test("Update birthday successfully", async ({ page }) => {
        ...
        await expect(page.locator(".d-flex.align-items-center.gap-5 p.lorem").nth(2)).toHaveText("01/01/1990")
    })
    ...
    test("Verify update basic information successfully", async ({ page }) => {
        ...
        await expect(page.locator(".d-flex.align-items-center.gap-5 p.lorem").nth(0)).toHaveText("Cang Nguyen")
        await expect(page.locator(".d-flex.align-items-center.gap-5 p.lorem").nth(1)).toHaveText("0987654321")
        await expect(page.locator(".d-flex.align-items-center.gap-5 p.lorem").nth(2)).toHaveText("02/02/1992")
    })
